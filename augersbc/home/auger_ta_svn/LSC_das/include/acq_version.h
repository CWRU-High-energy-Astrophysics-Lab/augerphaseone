...
/**
 * @defgroup acq_include Acquisition Include Files
 *
 */

/**
 * @defgroup acq_version_h Version of Acquisition
 * @ingroup acq_include
 *
 ...
 * 
 * @brief   Version of the Acquisition
*/

#define ACQ_VERSION 0x14022201
